...
export default function Analyze() {
    ...
    const handleImageSelected = async (image: File | string) => {
        ...
        try {
            const result = await createScan.mutateAsync(image);
                        ...
                        <div className="flex-1 space-y-6 text-center md:text-left">
                            ...
                            >
                                ...
                                <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-slate-900 leading-tight">
                                    Upload your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-500">scan.</span>
                                </h1>
                                <p className="text-lg text-slate-500 leading-relaxed max-w-lg mx-auto md:mx-0 mt-6">
                                    Our AI will analyze your skin lesion and provide a preliminary assessment based on specialized computer vision models.
                                </p>
                            </motion.div>
                        </div>
